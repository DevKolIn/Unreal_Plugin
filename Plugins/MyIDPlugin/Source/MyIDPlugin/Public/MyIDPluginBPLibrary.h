...
class UMyIDPluginBPLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set UserName", Keywords = "MyIDPlugin"), Category = "MyIDPluginTesting")
	static void SetUserName(const FString& NewName);

	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get UserName", Keywords = "MyIDPlugin"), Category = "MyIDPluginTesting")
